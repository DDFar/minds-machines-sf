...
SET REPO_NAME=minds-machines-sf
SET SHELL_SCRIPT_NAME=quickstart-initialize-space-uaa-timeseries.sh
SET APP_DIR="build-basic-app"
SET APP_NAME=MMSanFrancisco Space Setup
...
:INIT
  ...
  if "!doInstall!"=="Y" (
    ...
    ECHO.
    ECHO The required tools have been installed or you have chosen to not install them. Now you can proceed with the tutorial.
    pause
  )
